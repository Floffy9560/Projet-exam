...
<body>
  ...
  <div class="book" id="book">
    ...
    <h5><a href="#Haut de pages"><i class="bi bi-arrow-bar-up"></i></a></h5>
  </div>
  <div class="sideNav" id="sideNav">

    <div class="searchOnPage">
      <h5><a href="#Verres">Verres</a></h5>
      <h6><a href="#Verres unifocaux">Unifocaux</a></h6>
      <h6><a href="#Verres Progressifs">Progressifs</a></h6>
      <h6><a href="#Verres Dégressifs">Dégressifs</a></h6>
    </div>
    <div class="searchOnPage">
      <h5><a href="#Traitements">Traitements</a></h5>
      <h6><a href="#Traitement anti-rayures">Anti-rayures</a></h6>
      <h6><a href="#Traitement anti-reflets">Anti-reflets</a></h6>
      <h6><a href="#Filtres anti-lumière bleue">Anti lumière bleu</a></h6>
      <h6><a href="#Verres solaires">Solaires</a></h6>
    </div>
    <div class="searchOnPage">
      <h5><a href="#amétropies">Amétropie</a></h5>
      <h6><a href="#HYPERMÉTROPE">Hypermétropie</a></h6>
      <h6><a href="#ASTIGMATE">Astigmatisme</a></h6>
      <h6><a href="#PRESBYTE">Presbytie</a></h6>
      <h6><a href="#MYOPE">Myopie</a></h6>
    </div>
  </div>
  ...
  <main>
    <div class="main">
      ...
      <div class="DMLA">
        Les verres progressifs sont plutôt déconseillés chez les patients
